...
$(function(){
    ...
    // 自定义匹配密码，长度在6-12之间，只能包含字符、数字和下划线。
    jQuery.validator.addMethod("isMyPwd", function(value, element) {       
         return this.optional(element) || /^\w{6,12}$/.test(value);       
    }, "密码长度在6-12之间，只能包含字符、数字和下划线。");

    // 自定义匹配邮箱
    jQuery.validator.addMethod("isMyEmail", function(value, element) {
        return this.optional(element) || /^\w+@\w+\.(com|cn)$/.test(value);
    }, "请输入正确的邮箱");
